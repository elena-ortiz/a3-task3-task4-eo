...
The "control" group somewhat follows a linear trend but overall depicts wider spread seen above. The "annual" group is also generally linear, but shows a wider spread with tails either end. 
